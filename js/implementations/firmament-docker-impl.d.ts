...
export declare class FirmamentDockerImpl extends CommandImpl implements FirmamentDocker {
    private dockerode;
    constructor();
    createContainer(containerConfig: any, cb: (err: Error, container: dockerode.Container) => void): void;
    ...
    listImages(listAllImages: boolean, cb: (err: Error, images: dockerode.DockerImage[]) => void): void;
