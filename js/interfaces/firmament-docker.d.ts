...
export interface FirmamentDocker {
    createContainer(containerConfig: any, cb: (err: Error, container: DockerContainer) => void): any;
    ...
    listContainers(listAllContainers: boolean, cb: (err: Error, containers: DockerContainer[]) => void): any;
